...
activities = {
    ...
    "Basketball Team": {
        "description": "Team drills and competitive basketball games",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 15,
        "participants": ["alex@mergington.edu", "nina@mergington.edu"]
    },
    "Swimming Club": {
        "description": "Lap training and swim meet preparation",
    ...
    "Science Bowl": {
        "description": "Prepare for science competitions and quiz bowls",
        "schedule": "Wednesdays, 4:00 PM - 5:30 PM",
        "max_participants": 14,
        "participants": ["noah@mergington.edu", "zoe@mergington.edu"]
    },
    "Literature Circle": {
        "description": "Discuss novels, poetry, and literary ideas",
